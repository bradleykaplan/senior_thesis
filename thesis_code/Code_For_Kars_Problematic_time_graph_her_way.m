...
for instance=1:totalinstance
    ...
    NumStationsProbavg=getProbStationsavg(NumCarsPerStationOccupied,Nspots,time_vect,Tfinal,totalinstance,step,Nstations);
...
function ProbStationsavg = getProbStationsavg(NumCarsPerStationOccupied,Nspots,time_vect,Tfinal,totalinstance,step,Nstations)
dimension2 = size(NumCarsPerStationOccupied);
